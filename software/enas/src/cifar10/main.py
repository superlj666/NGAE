...
DEFINE_string("data_path", "./software/enas/data/cifar10", "")
DEFINE_string("output_dir", "/home/lijian/data/outputs_301501310050111400101", "")
...
DEFINE_string("child_fixed_arc", "3 0 1 5 0 1 3 1 0 0 5 0 1 1 1 4 0 0 1 0 1", "")
...
def train():
  ...
  with g.as_default():
    ...
    checkpoint_saver_hook = tf.train.CheckpointSaverHook(
      FLAGS.output_dir, save_steps=child_ops["num_train_batches"] * 100, saver=saver)
